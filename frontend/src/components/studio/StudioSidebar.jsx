...
export default function StudioSidebar({ activeTab, setActiveTab, user, onLogout }) {
  const navItems = [
    { id: 'overview', label: 'Overview & KPI', icon: LayoutDashboard },
    { id: 'schedule', label: 'Events Schedule', icon: CalendarDays },
    { id: 'packages', label: 'Booking Packages', icon: Package },
    { id: 'galleries', label: 'Client Galleries', icon: ImageIcon },
    { id: 'staff', label: 'Staff & Crew Hub', icon: Users },
    { id: 'reviews', label: 'Client Reviews', icon: Star },
    { id: 'profile', label: 'Studio Branding', icon: Building2 },
  ];
        ...
        <div className="flex items-center gap-3 mb-9">
          ...
          <div>
            ...
            <div className="text-[11px] text-textPalette-secondary dark:text-[#9A9AA6] uppercase tracking-[0.12em] mt-0.5 flex items-center gap-1 font-semibold">
              <Sparkles size={11} className="text-brand-primary dark:text-[#C8A96E]" /> Studio Suite
            </div>
          </div>
        </div>
